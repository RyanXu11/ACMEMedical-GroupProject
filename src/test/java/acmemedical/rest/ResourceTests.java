...
public class ResourceTests {
    ...
    public void test14_MedicalSchoolResource_Create_AdminOnly() {
        ...
        newSchool.setName("Resource Test Medical School");
    ...
    public void test15_MedicalTrainingResource_GetAll_NoAuthRequired() {
        // Anyone can get all medical trainings
        Response noAuthResponse = webTarget
        ...
        assertThat(noAuthResponse.getStatus(), is(200));
        List<MedicalTraining> trainings = noAuthResponse.readEntity(new GenericType<List<MedicalTraining>>(){});
    ...
    public void test27_DuplicateMedicalSchool_Returns409() {
        ...
        duplicateSchool.setName("University of California Medical School"); // This name already exists in test data
    ...
    public void test29_MethodNotAllowed_Returns405() {
        // Try to use PATCH method (not supported)
        Response response = webTarget
            .register(adminAuth)
            .path(PHYSICIAN_RESOURCE_NAME)
            .path("1")
        ...
        assertThat(response.getStatus(), is(405)); // Method Not Allowed
    }
