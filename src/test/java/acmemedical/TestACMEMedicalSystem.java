...
//    }
    ...
    public void test30_duplicate_medical_school() throws JsonMappingException, JsonProcessingException {
        ...
        duplicateSchool.setName("University of California Medical School");
    ...
    public void test40_comprehensive_error_handling() throws JsonMappingException, JsonProcessingException {
        ...
        assertThat(wrongMethodResponse.getStatus(), is(405));
        ...
        assertThat(unsupportedMediaResponse.getStatus(), is(415));
    }


    @Test
    public void test41_get_patient_by_id_user() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
            .register(userAuth)
            .path(PATIENT_RESOURCE_NAME)
            .path("1")
    ...
    @Test
    public void test42_get_medicine_by_id_user() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
            .register(userAuth)
            .path(MEDICINE_RESOURCE_NAME)
            .path("1")
    ...
    @Test
    public void test43_get_medical_school_by_id_user() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
            .register(userAuth)
            .path(MEDICAL_SCHOOL_RESOURCE_NAME)
            .path("1")
    ...
    @Test
    public void test44_get_medical_training_by_id_user() throws JsonMappingException, JsonProcessingException {
        Response response = webTarget
            .register(userAuth)
            .path(MEDICAL_TRAINING_RESOURCE_NAME)
            .path("1")
    ...
    @Test
    public void test45_create_patient_user_forbidden() throws JsonMappingException, JsonProcessingException {
        Patient newPatient = new Patient();
        newPatient.setFirstName("Forbidden");
        newPatient.setLastName("Patient");
    ...
    @Test
    public void test46_create_medicine_user_forbidden() throws JsonMappingException, JsonProcessingException {
        Medicine newMedicine = new Medicine();
        newMedicine.setDrugName("Forbidden Drug");
    ...
    @Test
    public void test47_create_medical_school_user_forbidden() throws JsonMappingException, JsonProcessingException {
        PublicSchool newSchool = new PublicSchool();
        newSchool.setName("Forbidden School");
    ...
    @Test
    public void test48_create_medical_training_user_forbidden() throws JsonMappingException, JsonProcessingException {
